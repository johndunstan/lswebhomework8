...
function firstItem (collection, cb) {
	cb(collection[0]);
}
...
function contains (collection, item, cb) {
...
function removeDuplicates (array, cb) {
  // Using ES6
  let foodsNoDuplicates = Array.from(new Set(array));
  cb( foodsNoDuplicates );

  // Could also do it in one line
